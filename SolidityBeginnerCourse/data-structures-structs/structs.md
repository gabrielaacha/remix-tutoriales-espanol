En Solidity podemos definir los tipos de data a medida en forma de *structs*. Structs son una colección de variables que pueden consistir en tipos de data diferentes. 
